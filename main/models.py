...
class ConsultingContract(models.Model):
    ...
    contract_date = models.DateField(default=timezone.now, verbose_name="Shartnoma sanasi")
    ...
    # Passport/ID karta rasmlari (max 2 ta)
    passport_images = models.JSONField(default=list, blank=True, verbose_name="Passport/ID karta rasmlari", help_text="Maksimal 2 ta rasm")
